        ...
        init: function (elementId)
        {
                        ...
                        onEachFeature: (feature, layer) =>
                        {
                            ...
                            layer.on({
                                ...
                                click: (e) =>
                                {
                                    ...
                                    if (countyId)
                                    {
                                        const cInfo = countyReference.find(c => c.id === countyId);
                                        if (cInfo)
                                        {
                                            loadCounty(countyId);
                ...
                if (stateData)
                {
                    ...
                    if (matched)
                    {
                        ...
                        if (newCountyId !== currentCountyId)
                        {
                            ...
                            const cInfo = countyReference.find(c => c.id === newCountyId);
            ...
            if (els.countySelect)
            {
                els.countySelect.addEventListener('change', (e) =>
                {
                    ...
                    let found = countyReference.find(c => c.id === val);
                    if (!found) found = countyReference.find(c => c.pop == val);
